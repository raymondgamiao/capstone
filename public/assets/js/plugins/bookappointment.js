        ...
        bookingcalendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function (info) {
                ...
                editelem.querySelector('[name="start_time"]').value =
                    info.event.extendedProps.starttime || "enter time";
                editelem.querySelector('[name="end_time"]').value =
                    info.event.extendedProps.endtime || "enter time";
                editelem.querySelector('[name="description"]').value =
                    info.event.extendedProps.desc || "provide description";
                editelem.querySelector("#editconfirm").checked =
