                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 class="counter">&#8369 20,000</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 class="counter">&#8369 15,000</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 class="counter">&#8369 3,500</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                                ...
                                <table id="basic-table" class="table mb-0 " role="grid">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <div class="icon iq-icon-box-3 rounded-pill">0905502203180</div>
                                                </div>
                                            </td>
                                            <td>&#8369 14,000</td>
                                            <td>
            ...
            <div class="card" data-aos="fade-up" data-aos-delay="600">
                ...
                <div class="card-body">
                    <div class="mb-2  d-flex profile-media align-items-top">
                        ...
                        <div class="ms-4">
                            <h6 class="mb-1 ">&#8369 2400, Purchase</h6>
